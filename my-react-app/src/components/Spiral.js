...
// Credit to Tiffany Rayside for the spiral code
const Spiral = () => {
    useEffect(() => {
        ...
        var c, $, w, h, msX, msY, midX, midY, num = 650, parts = [], begin = 50, repeat = 20, end = Math.PI * 2, force = null, msdn = false;
        var flow; // Define the 'flow' variable
        ...
        function start() {
            ...
            flow = begin; // Initialize the 'flow' variable
